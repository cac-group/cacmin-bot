...
- `/bangif [@username|userId] [gif_id] [-g]` - Ban a GIF: reply to it, or name a user and id; add `-g` for a global ban (`admin+`)
- `/getgifid` - Reply to a GIF to get its `file_unique_id` (`admin+`)
