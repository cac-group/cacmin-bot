		...
		children: [
			...
			},
			{
				...
				content: fmt([
					...
					"  Verify and credit your own deposit transaction by hash.\n\n",
					"/claimdeposit <txhash>\n",
					"  If a deposit was missed, send its hash and the bot will verify it on-chain and credit the user id in the memo.\n\n",
		...
		children: [
			{
				...
				content: fmt([
					...
					"\n\n",
					"/mystatus\n",
					"  View your role, warnings, jail status and bail amount, activity statistics, and unpaid fines.\n\n",
					"/jails\n",
			...
			},
			{
				...
				content: fmt([
					...
					"\n\n",
					"/ratelimit [user]\n",
					"  View your 15-minute, 1-hour, and 24-hour character usage, including one-period rollover capacity. Admins and owners may pass a user to view another user's usage.\n\n",
					"/ratelimits\n",
					"  Explain rate-limit windows, rollover, enforcement, and paid resets.\n\n",
					"/ratelimitreset [user] <15m|1h|24h>\n",
			...
			},
			{
				...
				content: fmt([
					...
					"/sendsticker [name]\n",
					"  Send a sticker from the CACGifs pack by name (currently only 'first' is configured; /sendsticker first sends the same sticker as /cac).\n\n",
					"/getsticker\n",
		...
		children: [
			...
			},
			{
				...
				content: fmt([
					...
					"  Challenge another user to a 1v1 wager. Both players put up the same amount and winner takes all. After the challenge is accepted, pick a loser penalty for the round.\n\n",
					"/duelstats\n",
					...
					bold("Loser Penalties:"),
					"\n",
					"  - No Penalty: nothing happens\n",
					"  - Jail (1 hour): loser is jailed\n",
					"  - Muted (30 minutes): loser cannot send messages\n",
					"  - No Stickers (1 hour): loser cannot send stickers\n",
					"  - No Media (1 hour): loser cannot send photos and media\n",
					"  - No GIFs (1 hour): loser cannot send GIFs\n",
					"  - No Forwarding (1 hour): loser cannot forward messages",
				]),
			},
		],
	},
		...
		children: [
			...
			},
			{
				...
				content: fmt([
					...
					"  Types: no_stickers, no_urls, no_media, no_photos, no_videos, no_documents, no_gifs, no_specific_gif (banned gif), no_voice, no_forwarding, regex_block, random_delete.\n",
					"  banned gif uses [action] as the GIF's file_unique_id (or just use /bangif).\n",
					...
					"/bangif [@username|userId] [gif_id] [-g]\n",
					"  Ban a GIF. Reply to a GIF to ban it for its author, or pass a user + id. Add -g to ban it for everyone.\n\n",
					"/getgifid\n",
					"  Reply to a GIF to get its file_unique_id.\n\n",
					"/regexhelp\n",
			...
			},
			{
				...
				content: fmt([
					...
					"  Configure a user's base limit; 1-hour is 2x and 24-hour is 8x the base. One period of unused capacity rolls over without compounding. Changing an existing limit resets accumulated counts. Emoji count as 2 characters, stickers as 5, and a shared image or file as 25.\n\n",
					"/clearratelimit <user>\n",
		...
		children: [
			...
			},
			{
				...
				content: fmt([
					...
					"  Adjust the bot treasury balance to correct ledger discrepancies found by /reconcile. Debit reduces, credit increases the internal total.",
				]),
			},
			{
