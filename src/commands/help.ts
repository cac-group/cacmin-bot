...
export const helpContent: Record<string, FmtString> = {
	...
	user: fmt([
		...
		"/ratelimit\n",
		"  View your current 15-minute, 1-hour, and 24-hour character usage.\n\n",
	...
	payments: fmt([
		...
		"/paybail\n",
		"  Pay your own bail, or specify a jailed user: /paybail <@username|userId>. You can also reply /paybail to their group message.\n\n",
	...
	admin: fmt([
		...
		"  Configure a user's base limit; 1-hour is 4x and 24-hour is 24x the hourly limit. Emoji count as 2 and stickers as 5 characters.\n\n",
		"/clearratelimit <user>\n",
