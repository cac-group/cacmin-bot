...
export const helpContent: Record<string, FmtString> = {
	...
	admin: fmt([
		...
		"  Configure a user's base limit; 1-hour is 4x and 24-hour is 24x the hourly limit. One period of unused capacity rolls over without compounding. Emoji count as 2 and stickers as 5 characters.\n\n",
		"/clearratelimit <user>\n",
