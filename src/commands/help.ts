...
export const helpContent: Record<string, FmtString> = {
	...
	games_duel: fmt([
		...
		code("/duel @user 10"),
		"\n",
		"  2. The challenge stays pending for up to 5 minutes\n",
		"  3. Opponent sees Accept/Decline buttons\n",
		"  4. If accepted, both balances are checked again, both players roll, and loser pays winner\n",
		"  5. If declined, cancelled, or expired, the pending challenge simply closes\n\n",
		"/duelstats\n",
	...
	admin: fmt([
		...
		"  Types: no_stickers, no_urls, no_media, no_photos, no_videos, no_documents, no_gifs, no_voice, no_forwarding, regex_block, random_delete.\n",
