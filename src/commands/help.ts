...
const helpContent: Record<string, FmtString> = {
	...
	games_duel: fmt([
		...
		"  4. If accepted, opponent's wager is reserved and both roll\n",
		"  5. If declined, cancelled, or expired (5 min), challenger is refunded\n\n",
		"/duelstats\n",
	...
	owner: fmt([
		...
		"/claimdeposit <txhash> <userid>\n",
		"  Manually assign an unclaimed deposit to a specific user.\n\n",
